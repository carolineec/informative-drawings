...
parser.add_argument('--checkpoints_dir', required=True, type=str, help='Where the model checkpoints are saved')
...
parser.add_argument('--predict_depth', type=int, default=1, help='run geometry prediction on the generated images')
parser.add_argument('--save_input', type=int, default=1, help='save input image')
